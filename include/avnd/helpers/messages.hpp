...
#define avnd_mem_fun_t(Mem, MemT) avnd::func_ref<#Mem, &parent_type::Mem MemT> AVND_TOKENPASTE2(m_, AVND_TOKENPASTE2(Mem, __LINE__));
#define avnd_free_fun(Fun) avnd::func_ref<#Fun, Fun> m_##Fun;
#define avnd_free_fun_t(Fun, FunT) avnd::func_ref<#Fun, Fun FunT> AVND_TOKENPASTE2(m_, AVND_TOKENPASTE2(Mem, __LINE__));
