...
struct event_bus_info
{
  ...
  static Steinberg::tresult outputInfo(
      Steinberg::int32 index,
      Steinberg::Vst::BusInfo& info)
  {
    using namespace Steinberg::Vst;
  ...
  Steinberg::tresult activateInput(
  ...
  Steinberg::tresult activateOutput(
      Steinberg::int32 index, Steinberg::TBool state)
  {
...
static constexpr inline Steinberg::tresult default_speaker_arrangement(
    int channels,
...
struct audio_bus_info
{
  ...
  static Steinberg::tresult inputArrangement(
      Steinberg::int32 index,
      Steinberg::Vst::SpeakerArrangement& arr)
  {
    return Steinberg::kInvalidArgument;
  ...
  static Steinberg::tresult outputArrangement(
      Steinberg::int32 index,
      Steinberg::Vst::SpeakerArrangement& arr)
  {
    return Steinberg::kInvalidArgument;
  ...
  static Steinberg::tresult activateInput(
      Steinberg::int32 index, Steinberg::TBool state)
  {
    return Steinberg::kInvalidArgument;
  }

  static Steinberg::tresult activateOutput(
      Steinberg::int32 index, Steinberg::TBool state)
  {
    return Steinberg::kInvalidArgument;
  }
