...
// Classic backend is used even when reflection is available: it handles member
// -function template instantiations and free functions that the p2996 one cannot.
