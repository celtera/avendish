...
#include <vintage/atomic_controls.hpp>
#include <vintage/dispatch.hpp>
#include <vintage/helpers.hpp>
#include <vintage/midi_processor.hpp>
#include <vintage/processor_setup.hpp>
#include <vintage/programs.hpp>
