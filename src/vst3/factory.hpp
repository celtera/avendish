...
#include <common/limited_string_view.hpp>
...
using class_subcategories = avnd::limited_string_view<Steinberg::PClassInfo2::kSubCategoriesSize>;
...
public:
  Steinberg::tresult queryInterface(const Steinberg::TUID iid, void** obj) override
  {
    ...
    QUERY_INTERFACE(iid, obj, Steinberg::IPluginFactory2::iid, Steinberg::IPluginFactory2)
    QUERY_INTERFACE(iid, obj, Steinberg::IPluginFactory3::iid, Steinberg::IPluginFactory3)
  ...
  Steinberg::tresult getClassInfo(int32 index, Steinberg::PClassInfo* info) override
  {
    ...
    switch(index)
    {
      ...
      case 1:
      {
        ...
        snprintf(info->name, Steinberg::PClassInfo::kNameSize, "%sController", T::name());
        return Steinberg::kResultOk;
      }
      default:
  ...
  Steinberg::tresult getClassInfoUnicode(int32 index, Steinberg::PClassInfoW* info) override
  {
    ...
    switch(index)
    {
      ...
      case 1:
      {
        ...
        avnd::limited_string_view<Steinberg::PClassInfo::kNameSize - name_len>{"Controller"}.copy_to(info->name + name_len);
        break;
      }
      default:
        return Steinberg::kInvalidArgument;
  ...
  Steinberg::tresult createInstance(Steinberg::FIDString cid, Steinberg::FIDString _iid, void** obj) override
  {
