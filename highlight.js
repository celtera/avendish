...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `cpp` grammar compiled for Highlight.js 11.5.0 */
...
;hljs.registerLanguage("dos",e)})();/*! `arduino` grammar compiled for Highlight.js 11.5.0 */
...
;hljs.registerLanguage("arduino",e)})();/*! `javascript` grammar compiled for Highlight.js 11.5.0 */
(()=>{var e=(()=>{"use strict"
...
})();hljs.registerLanguage("xml",e)})();/*! `qml` grammar compiled for Highlight.js 11.5.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("qml",e)})();/*! `bash` grammar compiled for Highlight.js 11.5.0 */
...
;hljs.registerLanguage("bash",e)})();/*! `python` grammar compiled for Highlight.js 11.5.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("python-repl",a)})();/*! `c` grammar compiled for Highlight.js 11.5.0 */
...
strings:i,keywords:u}}}})();hljs.registerLanguage("c",e)})();/*! `matlab` grammar compiled for Highlight.js 11.5.0 */
...
;hljs.registerLanguage("matlab",e)})();/*! `glsl` grammar compiled for Highlight.js 11.5.0 */
...
className:"meta",begin:"#",end:"$"}]})})();hljs.registerLanguage("glsl",e)})();/*! `shell` grammar compiled for Highlight.js 11.5.0 */
